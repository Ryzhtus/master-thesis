from reader import ReaderOntonotes
...
reader = ReaderOntonotes(tokenizer_fast, 256)

train_documents = reader.parse("", fit_vectorizer=True)
eval_documents = reader.parse("", fit_vectorizer=False)
test_documents = reader.parse("", fit_vectorizer=False)
...
if params['add_features']:
    ...
    logger = WandbLogger(project="NERDocumentFeatures", save_dir="")
